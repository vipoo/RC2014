...
uint8_t i808x_debug_read(uint16_t addr) { return i808x_do_read(addr); /* No side effects */ }

uint8_t i808x_read8(void *mem, unsigned long addr) { return i808x_do_read(addr); }
...
void i808x_write8(void *mem, unsigned long addr, uint8_t val) { do_i808x_write(addr, val); }
...
static uint8_t i808x_in8(void *mem, unsigned long addr) { return i808x_inport(addr & 0xFFFF); }
...
static void i808x_out8(void *mem, unsigned long addr, uint8_t val) { i808x_outport(addr, val); }
