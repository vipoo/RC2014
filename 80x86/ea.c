...
/* EA 00: [BX + SI] */
static void ea_get00(e8086_t *c) {
  c->ea.is_mem = 1;
...
/* EA 01: [BX + DI] */
static void ea_get01(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
...
/* EA 02: [BP + SI] */
static void ea_get02(e8086_t *c) {
  c->ea.is_mem = 1;
...
/* EA 03: [BP + DI] */
static void ea_get03(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ss(c);
...
/* EA 04: [SI] */
static void ea_get04(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
...
/* EA 05: [DI] */
static void ea_get05(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
...
/* EA 06: [XXXX] */
static void ea_get06(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
...
/* EA 07: [BX] */
static void ea_get07(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
...
/* EA 08: [BX + SI + XX] */
static void ea_get08(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
...
/* EA 09: [BX + DI + XX] */
static void ea_get09(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
...
/* EA 0A: [BP + SI + XX] */
static void ea_get0a(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ss(c);
...
/* EA 0B: [BP + DI + XX] */
static void ea_get0b(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ss(c);
...
/* EA 0C: [SI + XX] */
static void ea_get0c(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
...
/* EA 0D: [DI + XX] */
static void ea_get0d(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
...
/* EA 0E: [BP + XX] */
static void ea_get0e(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ss(c);
...
/* EA 0F: [BX + XX] */
static void ea_get0f(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
...
/* EA 10: [BX + SI + XXXX] */
static void ea_get10(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
  c->ea.ofs    = e86_get_bx(c) + e86_get_si(c);
  c->ea.ofs += e86_mk_uint16(c->ea.data[1], c->ea.data[2]);
...
/* EA 11: [BX + DI + XXXX] */
static void ea_get11(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
  c->ea.ofs    = e86_get_bx(c) + e86_get_di(c);
  c->ea.ofs += e86_mk_uint16(c->ea.data[1], c->ea.data[2]);
...
/* EA 12: [BP + SI + XXXX] */
static void ea_get12(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ss(c);
  c->ea.ofs    = e86_get_bp(c) + e86_get_si(c);
  c->ea.ofs += e86_mk_uint16(c->ea.data[1], c->ea.data[2]);
...
/* EA 13: [BP + DI + XXXX] */
static void ea_get13(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ss(c);
  c->ea.ofs    = e86_get_bp(c) + e86_get_di(c);
  c->ea.ofs += e86_mk_uint16(c->ea.data[1], c->ea.data[2]);
...
/* EA 14: [SI + XXXX] */
static void ea_get14(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
  c->ea.ofs    = e86_get_si(c);
  c->ea.ofs += e86_mk_uint16(c->ea.data[1], c->ea.data[2]);
...
/* EA 15: [DI + XXXX] */
static void ea_get15(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
  c->ea.ofs    = e86_get_di(c);
  c->ea.ofs += e86_mk_uint16(c->ea.data[1], c->ea.data[2]);
...
/* EA 16: [BP + XXXX] */
static void ea_get16(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ss(c);
...
/* EA 17: [BX + XXXX] */
static void ea_get17(e8086_t *c) {
  c->ea.is_mem = 1;
  c->ea.seg    = e86_get_ds(c);
  c->ea.ofs    = e86_get_bx(c);
  c->ea.ofs += e86_mk_uint16(c->ea.data[1], c->ea.data[2]);
...
/* EA 18-1F: REG */
static void ea_get18(e8086_t *c) {
  c->ea.is_mem = 0;
  c->ea.seg    = 0;
...
e86_ea_f e86_ea[32] = {&ea_get00, &ea_get01, &ea_get02, &ea_get03, &ea_get04, &ea_get05, &ea_get06, &ea_get07, &ea_get08, &ea_get09, &ea_get0a, &ea_get0b, &ea_get0c, &ea_get0d, &ea_get0e, &ea_get0f,
                       &ea_get10, &ea_get11, &ea_get12, &ea_get13, &ea_get14, &ea_get15, &ea_get16, &ea_get17, &ea_get18, &ea_get18, &ea_get18, &ea_get18, &ea_get18, &ea_get18, &ea_get18, &ea_get18};
