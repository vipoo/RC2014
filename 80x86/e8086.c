...
void e86_set_addr_mask(e8086_t *c, unsigned long msk) { c->addr_mask = msk; }

unsigned long e86_get_addr_mask(e8086_t *c) { return (c->addr_mask); }
...
static unsigned char e86_get_mem_uint8(void *mem, unsigned long addr) { return (0xaa); }

static unsigned short e86_get_mem_uint16(void *mem, unsigned long addr) { return (0xaaaa); }
...
void e86_irq(e8086_t *cpu, unsigned char val) { cpu->irq = (val != 0); }

static void e86_irq_ack(e8086_t *c) {
  unsigned char irq;
