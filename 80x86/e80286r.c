...
static unsigned op_0f_01_00(e8086_t *c) {
...
static unsigned op_0f_01_01(e8086_t *c) {
  e86_get_ea_ptr(c, c->pq + 2);
...
static unsigned op_0f_01_04(e8086_t *c) {
  e86_get_ea_ptr(c, c->pq + 2);
  e86_set_ea16(c, 0x0000);
...
static unsigned op_0f_01_06(e8086_t *c) {
  unsigned short val;
...
/* OP 0F 01 */
static unsigned op_0f_01(e8086_t *c) {
