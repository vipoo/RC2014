...
/* OP 60: PUSHA */
static unsigned op_60(e8086_t *c) {
  unsigned short tmp;
...
/* OP 61: POPA */
static unsigned op_61(e8086_t *c) {
...
static unsigned op_62(e8086_t *c) {
  long           s1, lo, hi;
...
/* OP 68: PUSH imm16 */
static unsigned op_68(e8086_t *c) {
...
static unsigned op_69(e8086_t *c) {
...
/* OP 6A: PUSH imm8 */
static unsigned op_6a(e8086_t *c) {
...
static unsigned op_6b(e8086_t *c) {
  unsigned long s1, s2, d;
...
/* OP 6C: INSB */
static unsigned op_6c(e8086_t *c) {
  unsigned short inc;
...
/* OP 6D: INSW */
static unsigned op_6d(e8086_t *c) {
  unsigned short inc;
...
/* OP 6E: OUTSB */
static unsigned op_6e(e8086_t *c) {
  unsigned short seg;
  unsigned short inc;
...
/* Opcode 6F: OUTSW */
static unsigned op_6f(e8086_t *c) {
  unsigned short seg;
  unsigned short inc;
...
static unsigned op_c0(e8086_t *c) {
  unsigned       xop;
  unsigned       cnt;
  unsigned short d, s;
...
static unsigned op_c1(e8086_t *c) {
  unsigned      xop;
  unsigned      cnt;
  unsigned long d, s;
...
static unsigned op_c8(e8086_t *c) {
  unsigned char  level;
  unsigned short tmp;
...
/* OP C9: LEAVE */
static unsigned op_c9(e8086_t *c) {
