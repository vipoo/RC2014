 ...
 */
uint8_t *z80copro_eprom(struct z80copro *c) { return c->eprom; }
...
int z80copro_intraised(struct z80copro *c) { return (c->latches & MAINT) ? 0 : 1; }
...
void z80copro_trace(struct z80copro *c, int onoff) { c->trace = onoff; }
