...
uint8_t cp1802_ef(struct cp1802 *cpu) { return 0xFF; }

void cp1802_q_set(struct cp1802 *cpu) { /* Whatever - maybe log this */
}
...
uint8_t cp1802_dma_in(struct cp1802 *cpu) { return 0xFF; /* TODO */ }

void cp1802_dma_out(struct cp1802 *cpu, uint8_t val) { /* TODO */
}
...
void recalc_interrupts(void) { cp1802_interrupt(&cpu, live_irq); }
